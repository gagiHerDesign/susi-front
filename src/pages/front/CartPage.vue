      ...
      <div id="cart" class="col-12 col-md-8 q-py-xl">
        ...
        <div style="max-width: 100%">
          <div class="q-pa-md q-gutter-md">
            ...
            <q-separator />
            <!-- 購物車的商品們 -->
            <q-item clickable class="text-center q-my-xl" style="background: #fff;" v-for="(product, idx) in cart" :key="product._id">
              <q-item-section>
              ...
              <q-item-section>
                <q-btn label="取消" @click="updateCart(idx, product.quantity * -1)" icon="delete"></q-btn>
              </q-item-section>
